...
Atualmete no segundo ano do curso de <strong>Tecnologias de Informação</strong> da [Universidade Católica de Moçambique](https://ucm.ac.mz), <strong>Cledson Vilanculo</strong> é um jovem programador java e web front-end e também web designer apaixonado por tecnologia.
Para além de programar ele também cria apresentações (slides) PowerPoint e edita fotos.<br>
